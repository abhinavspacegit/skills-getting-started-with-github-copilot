...
activities = {
    ...
    "Soccer Team": {
        ...
        "schedule": "Mondays, Wednesdays, Saturdays, 4:00 PM - 6:00 PM",
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "chris@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Skills development, scrimmages, and league play",
...
def signup_for_activity(activity_name: str, email: str):
    ...
    if len(activity["participants"]) >= activity["max_participants"]:
        raise HTTPException(status_code=400, detail="Activity is full - no spots remaining")
